...
parser.add_argument('--units', type=int, default=50, help=u'Unit size')
parser.add_argument('--dropout', type=float, default=0.33, help=u'Dropout rate of LSTMs')
parser.add_argument('--blstm', type=int, default=2, help=u'BiLSTM stack size')
...
parser.add_argument('--epoch', type=int, default=40, help=u'Epoch num')
...
parser.add_argument('--dev_rate', type=float, default=0.1, help=u'Development set ratio')
